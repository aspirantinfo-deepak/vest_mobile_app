      ...
      <div className="container pt-3 pb-5 mb-5 ">
        ...
        <div className="row mb-3 mt-2">
          <div className="col-12 ">
            <h3 className="subheading">Recently viewed</h3>
          </div>
        </div>
        <div className="row">
          <div className="col-12 wrap_stk ">
            <span className="stock_tags">HOOD</span>
            <span className="stock_tags">AAPl</span>
            <span className="stock_tags">USO</span>
            <span className="stock_tags">TSLA</span>
            <span className="stock_tags">DOWJ</span>
            <span className="stock_tags">BTC</span>
            <span className="stock_tags">ETH</span>
            <span className="stock_tags">TSLA</span>
          </div>
        </div>
        ...
        <div className="row px-1 mb-5 pb-5">
          <div className="col-6 mt-3 px-2">
            <div className="card_watchlist shd1">
              ...
              <div>
                <p>$31,373.44</p>
                <span className="postve">+15.41%</span>
              </div>
            </div>
          </div>
          <div className="col-6 mt-3 px-2">
            <div className="card_watchlist shd2">
              <div>
                <h6>USO</h6>
                <h5>United States Oil Imported from Saudi Futures</h5>
              </div>
              <div>
                <p>$31,373.44</p>
                <span className="postve">+15.41%</span>
          ...
          <div className="col-6 mt-3 px-2">
            <div className="card_watchlist shd3">
              <div>
                <h6>AAPL</h6>
                <h5>Apple Computers</h5>
              </div>
              <div>
                <p>$31,373.44</p>
                <span className="negtve">+15.41%</span>
              </div>
            </div>
          </div>
          <div className="col-6 mt-3 px-2">
            <div className="card_watchlist shd4">
              <div>
                <h6>USO</h6>
                <h5>United States Oil Imported from Saudi Futures</h5>
              </div>
