...
const AnimatedNumStock: React.FC<AnimatedNumberProps> = ({
  value,
  duration = 1000,
}) => {
  //   var assetsValue: any;
  //   setInterval(() => {
  //     assetsValue = localStorage.getItem("assetsValue1");
  //     if (assetsValue) {
  //       setDisplayValue(assetsValue);
  //     } else {
...
export default AnimatedNumStock;
