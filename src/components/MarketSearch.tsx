        ...
        <div>
            ...
            <div className="col-12 mt-1">
              ...
              >
                ...
                <span>
                  ...
                  {interval == "1y" && "past year"} {interval == "all" && "all"}
                </span>
              </p>
            </div>
          </div>
          ...
          <div className="row">
            <div className="col-12 border_btm_dotted" style={{ padding: 0 }}>
              {sampleData.length > 0 && (
                <StockGraph data={sampleData} currentPrice={setcurrentPrice} />
              )}
            </div>
          ...
          <div className="row mt-3">
            ...
            <div className="col-4 mb-3">
              ...
              <p className="para6">
                {userTickerPosition?.quantity &&
                  formatCurrency2(userTickerPosition?.quantity * currentPrice)}
                {!userTickerPosition?.quantity && "--"}
              </p>
            </div>
            <div className="col-4 mb-3">
            ...
            <div className="col-4 mb-3">
              ...
              >
                {returnData ? <> {fc(returnData.realizedPercentage)}%</> : "--"}
              </p>
            </div>
          </div>
